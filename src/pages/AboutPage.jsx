        ...
        <>
            <section className="relative h-64 md:h-96 w-full overflow-hidden border-b dark:border-gray-700">
                <div className="absolute inset-0 z-10 hover:animate-out overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-900/40 to-purple-900/40 dark:from-blue-900/40 dark:to-gray-900/60 mix-blend-multiply dark:mix-blend-normal"></div>
                    <div className="absolute inset-0 bg-gradient-to-b from-transparent to-background/90 dark:to-background/50 bg-opacity-20" />
                </div>
